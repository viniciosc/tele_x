...
var getUserByName = function (userName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userRepository.findOneBy({ name: userName })];
            case 1:
                user = _a.sent();
...
var createUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var hasPassword, newUser, password, userWithoutPassword;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                _a.label = 2;
            case 2: return [4 /*yield*/, userRepository.save(user)];
            case 3:
                newUser = _a.sent();
...
exports.default = { getUsers: getUsers, getUserByName: getUserByName, getUserById: getUserById, createUser: createUser };
