...
loginRouter.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, password, user, verifyPass, token, _, userLogin;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (!user)
                    return [2 /*return*/, res.status(400).json({ message: 'Usuário ou senha inválidos!' })];
                return [4 /*yield*/, bcrypt_1.default.compare(password, user.password)];
            case 2:
                verifyPass = _b.sent();
                if (!verifyPass)
                    return [2 /*return*/, res.status(400).json({ message: 'Usuário ou senha inválidos!' })];
                token = jsonwebtoken_1.default.sign({ id: user.id }, process.env.JWT_PASS, {
                    expiresIn: '8h',
                });
...
loginRouter.get('/profile', authMiddleware_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
